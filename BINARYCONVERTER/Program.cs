...
namespace BINARYCONVERTER
{
    class Program
    {
        static void Decode(string binStr)
        {
            string test = binStr;
            ...
            Console.WriteLine($"Your decoded string is:\n\n{formatted}");
        }

        static void Encode(string binStr)
        {
            ...
            Console.WriteLine($"Your encoded string is:\n\n{binStr}");
        }
        ...
        static void Main(string[] args)
        {
            while (true)
            {
                ...
                {
                    Console.WriteLine("please type encode, decode, or quit");
                }
            }
        }
    }
